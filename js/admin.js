...
function handleAddBtnClick() {
    ...
    modalInner.innerHTML = `
        <form autocomplete="off" class="add-pool-form w-[900px] p-5 bg-[#F8F8F8] rounded-[20px]">
            <label>
            ...
            <div class="flex justify-between mt-5">
                <div class="w-[49%] flex flex-col gap-[20px]">
                    <label>
                        <span class="pl-5 text-[18px] text-[#898989]">Выберите категорию</span>
                        <select name="categoryId" class="w-full pl-3 text-[20px] py-3 bg-white shadow-md">
                    ...
                    <label>
                        ...
                        <input name="oldPrice" type="number" class="w-full pl-3 text-[20px] py-2 bg-white shadow-md" placeholder="Старая цена"/>
                    </label>
                    <label>
                        <span class="pl-5 text-[18px] text-[#898989]">Введите новую цену</span>
                        <input name="newPrice" type="number" class="w-full pl-3 text-[20px] py-2 bg-white shadow-md" placeholder="Новая цена"/>
                    </label>
                </div>
                <div class="w-[49%] flex flex-col gap-[20px]">
                    <label>
                        <span class="pl-5 text-[16px] text-[#898989]">Введите количество</span>
                        <input name="quantity" type="number" class="w-full pl-3 text-[20px] py-2 bg-white shadow-md" placeholder="Количество"/>
                    </label>
                    <label>
                    ...
                    <button class="add-btn bg-[#009398] text-white py-[8px] rounded-[30px] mt-[25px] font-bold text-[22px] hover:opacity-[70%] duration-300 px-[14px]">Добавить </button>
                </div>
            </div>
        </form>
    `
        ...
        <form autocomplete="off" class="add-pool-form w-[1000px] p-5 bg-[#F8F8F8] rounded-[20px]">
            ...
            <div class="flex justify-between mt-10">
                <div class="w-[49%] flex flex-col gap-[20px]">
                    <label>
                        <span class="pl-5 text-[18px] text-[#898989]">Выберите категорию</span>
                        <select name="categoryId" class="w-full pl-5 text-[20px] py-3 bg-white shadow-md">
                    ...
                    <label>
                        <span class="pl-5 text-[18px] text-[#898989]">Введите старую цену</span>
                        <input value="${findedObj.oldPrice}" name="oldPrice" type="number" class="w-full pl-5 text-[20px] py-2 bg-white shadow-md" placeholder="Старая цена"/>
                    </label>
                    <label>
                        <span class="pl-5 text-[18px] text-[#898989]">Введите новую цену</span>
                        <input value="${findedObj.newPrice}" name="newPrice" type="number" class="w-full pl-5 text-[20px] py-2 bg-white shadow-md" placeholder="Новая цена"/>
                    </label>
                </div>
                <div class="w-[49%] flex flex-col gap-[20px]">
                    <label>
                        <span class="pl-5 text-[16px] text-[#898989]">Введите количество</span>
                        <input value="${findedObj.quantity}" name="quantity" type="number" class="w-full pl-5 text-[20px] py-2 bg-white shadow-md" placeholder="Количество"/>
                    </label>
                    <label>
                        <span class="pl-5 text-[18px] text-[#898989]">Введите рамку</span>
                        <select name="frameId" class="w-full pl-5 text-[20px] py-3 bg-white shadow-md">
                    ...
                    <button class="add-btn bg-[#009398] text-white py-[8px] rounded-[30px] mt-[28px] font-bold text-[22px] hover:opacity-[70%] duration-300 px-[14px]">Обнавить</button>
                </div>
            </div>
        </form>
    `
