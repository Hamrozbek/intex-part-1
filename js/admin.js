...
function handleAddBtnClick() {
  modalWrapper.classList.remove("scale-0");
  modalInner.innerHTML = `
    <form autocomplete="off" class="w-[900px] p-5 bg-[#F8F8F8] rounded-[20px]">
      <label>
        <input type="file" class="hidden" />
        <div class="relative mx-auto flex items-center justify-center border-[2px] border-dashed border-slate-500 w-[69%] h-[316px] bg-white rounded-[20px]">
      ...
      <div class="flex justify-between mt-10">
        <div class="w-[49%] flex flex-col gap-[30px]">
          <label>
            ...
            <select name="categoryId" class="w-full pl-5 text-[14px] py-3 bg-white shadow-md">
          ...
          <label>
            <span class="pl-5 text-[14px] text-[#898989]">Введите старую цену</span>
            <input name="oldPrice" type="number" class="w-full pl-5 text-[14px] py-3 bg-white shadow-md" placeholder="Старая цена" />
          </label>

          <label>
            <span class="pl-5 text-[14px] text-[#898989]">Введите новую цену</span>
            <input name="newPrice" type="number" class="w-full pl-5 text-[14px] py-3 bg-white shadow-md" placeholder="Новая цена" />
          </label>
        </div>

        <div class="w-[49%] flex flex-col gap-[30px]">
          <label>
            <span class="pl-5 text-[14px] text-[#898989]">Введите количество</span>
            <input name="quantity" type="number" class="w-full pl-5 text-[14px] py-3 bg-white shadow-md" placeholder="Количество" />
          </label>

          <label>
            <span class="pl-5 text-[14px] text-[#898989]">Введите рамку</span>
            <select name="frameId" class="w-full pl-5 text-[14px] py-3 bg-white shadow-md">
          ...
          <button class="bg-[#009398] text-white py-[10px] rounded-[30px] mt-[25px] font-bold text-[14px] hover:opacity-[70%] duration-300 px-[14px]">Добавить</button>
        </div>
      </div>
    </form>`;
}
